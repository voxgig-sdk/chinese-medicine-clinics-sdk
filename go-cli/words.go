...
func registerSDKWords(r *eng.Registry, client *sdk.ChineseMedicineClinicsSDK) {
...
func runOp(client *sdk.ChineseMedicineClinicsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
