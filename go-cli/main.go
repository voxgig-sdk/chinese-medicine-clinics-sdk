// Command ChineseMedicineClinics-cli is a CLI + REPL for the ChineseMedicineClinics SDK,
...
const prompt = "chinese-medicine-clinics"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "annual_attendances_en annual_attendances_sc annual_attendances_tc"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      CHINESE_MEDICINE_CLINICS_APIKEY (api key), CHINESE_MEDICINE_CLINICS_BASE (base url override)")
