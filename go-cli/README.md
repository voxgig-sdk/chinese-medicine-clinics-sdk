...
AQL-driven command-line client **and** interactive REPL for the ChineseMedicineClinics
...
- `<entity>` is a bareword, auto-quoted as an AQL atom (e.g. `annual_attendances_en`).
