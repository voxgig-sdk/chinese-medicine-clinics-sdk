...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.CHINESEMEDICINECLINICS_TEST_LIVE ||
    'TRUE' === process.env.CHINESEMEDICINECLINICS_TEST_OVERRIDE
  ) {
  ...
  m.CHINESEMEDICINECLINICS_TEST_EXPLAIN = process.env.CHINESEMEDICINECLINICS_TEST_EXPLAIN || m.CHINESEMEDICINECLINICS_TEST_EXPLAIN
