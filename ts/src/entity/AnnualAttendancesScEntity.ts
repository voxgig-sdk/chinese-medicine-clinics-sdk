...
class AnnualAttendancesScEntity extends ChineseMedicineClinicsEntityBase<AnnualAttendancesSc> {
  ...
  make(this: AnnualAttendancesScEntity) {
  ...
  async list(this: any, reqmatch?: AnnualAttendancesScListMatch, ctrl?: Control): Promise<AnnualAttendancesScEntity[]> {
