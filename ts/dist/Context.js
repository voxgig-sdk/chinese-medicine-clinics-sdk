...
const ChineseMedicineClinicsError_1 = require("./ChineseMedicineClinicsError");
...
class Context {
    ...
    error(code, msg) {
        return new ChineseMedicineClinicsError_1.ChineseMedicineClinicsError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
