# ChineseMedicineClinics TypeScript SDK



The TypeScript SDK for the ChineseMedicineClinics API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.AnnualAttendancesEn()` — each with a small set of operations (`list`)
...
| Method | Returns | Description |
| --- | --- | --- |
| `ChineseMedicineClinicsSDK.test(testopts?, sdkopts?)` | `ChineseMedicineClinicsSDK` | Create a test-mode client. |
...
├── src/
│   ├── ChineseMedicineClinicsSDK.ts        # Main SDK class
...
await annualattendancesen.list()

// annualattendancesen.data() now returns the annualattendancesen data from the last `list`
// annualattendancesen.match() returns the last match criteria
```
