...
(0, node_test_1.describe)('AnnualAttendancesScEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'annual_attendances_sc.' + op, live))
                return;
        }
        ...
        let annual_attendances_sc_ref01_data = Object.values(setup.data.existing.annual_attendances_sc)[0];
        // LIST
        const annual_attendances_sc_ref01_ent = client.AnnualAttendancesSc();
        const annual_attendances_sc_ref01_match = {};
        const annual_attendances_sc_ref01_list = (await annual_attendances_sc_ref01_ent.list(annual_attendances_sc_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/annual_attendances_sc/AnnualAttendancesScTestData.json');
    ...
    let idmap = transform(['annual_attendances_sc01', 'annual_attendances_sc02', 'annual_attendances_sc03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=AnnualAttendancesScEntity.test.js.map