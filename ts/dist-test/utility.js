...
function envOverride(m) {
    if ('TRUE' === process.env.CHINESE_MEDICINE_CLINICS_TEST_LIVE ||
        'TRUE' === process.env.CHINESE_MEDICINE_CLINICS_TEST_OVERRIDE) {
    ...
    m.CHINESE_MEDICINE_CLINICS_TEST_EXPLAIN = process.env.CHINESE_MEDICINE_CLINICS_TEST_EXPLAIN || m.CHINESE_MEDICINE_CLINICS_TEST_EXPLAIN;
    return m;
}
