...
class ChineseMedicineClinicsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ChineseMedicineClinicsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ChineseMedicineClinicsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ChineseMedicineClinicsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
