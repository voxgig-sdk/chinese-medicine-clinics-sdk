# ChineseMedicineClinics SDK feature corpus test
#
...
def _client(kase):
    ...
    ChineseMedicineClinicsSDK(...), not ChineseMedicineClinicsSDK.test(...): the `test` feature is
    ...
    return ChineseMedicineClinicsSDK(opts)
