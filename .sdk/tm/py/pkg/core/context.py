...
from projectname_sdk.core.control import ChineseMedicineClinicsControl
...
class ChineseMedicineClinicsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ChineseMedicineClinicsControl()
        ...
        if isinstance(sp, ChineseMedicineClinicsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ChineseMedicineClinicsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ChineseMedicineClinicsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return ChineseMedicineClinicsOperation({})
    ...
    def make_error(self, code, msg):
        return ChineseMedicineClinicsError(code, msg, self)
