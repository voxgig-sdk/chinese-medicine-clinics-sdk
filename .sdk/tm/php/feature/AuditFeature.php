...
// ChineseMedicineClinics SDK audit feature
...
class ChineseMedicineClinicsAuditFeature extends ChineseMedicineClinicsBaseFeature
{
    ...
    private function _emit(ChineseMedicineClinicsContext $ctx, string $outcome): void
    {
