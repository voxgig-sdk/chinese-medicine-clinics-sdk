...
// ChineseMedicineClinics SDK netsim feature
...
class ChineseMedicineClinicsNetsimFeature extends ChineseMedicineClinicsBaseFeature
{
    ...
    private function _simulate(ChineseMedicineClinicsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ChineseMedicineClinicsContext $ctx, array $applied): void
    {
        $client = $this->client;
