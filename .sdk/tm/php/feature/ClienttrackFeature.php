...
// ChineseMedicineClinics SDK clienttrack feature
...
class ChineseMedicineClinicsClienttrackFeature extends ChineseMedicineClinicsBaseFeature
{
    ...
    public function PostConstruct(ChineseMedicineClinicsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ChineseMedicineClinics-SDK';
