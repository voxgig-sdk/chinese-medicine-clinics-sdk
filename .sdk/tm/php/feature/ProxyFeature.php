...
// ChineseMedicineClinics SDK proxy feature
...
class ChineseMedicineClinicsProxyFeature extends ChineseMedicineClinicsBaseFeature
{
    ...
    public function init(ChineseMedicineClinicsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ChineseMedicineClinicsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
