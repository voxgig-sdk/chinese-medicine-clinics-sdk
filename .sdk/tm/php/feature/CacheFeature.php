...
// ChineseMedicineClinics SDK cache feature
...
class ChineseMedicineClinicsCacheFeature extends ChineseMedicineClinicsBaseFeature
{
    ...
    private function _through(ChineseMedicineClinicsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
