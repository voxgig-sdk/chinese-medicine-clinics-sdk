...
// ChineseMedicineClinics SDK ratelimit feature
...
class ChineseMedicineClinicsRatelimitFeature extends ChineseMedicineClinicsBaseFeature
{
    ...
    private function _acquire(ChineseMedicineClinicsContext $ctx): void
    {
    ...
    private function _track(ChineseMedicineClinicsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
