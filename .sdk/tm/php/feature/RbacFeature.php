...
// ChineseMedicineClinics SDK rbac feature
...
class ChineseMedicineClinicsRbacFeature extends ChineseMedicineClinicsBaseFeature
{
    ...
    private function _required(ChineseMedicineClinicsContext $ctx): ?string
    {
    ...
    private function _reject(ChineseMedicineClinicsContext $ctx, string $required): void
    {
    ...
    private function _track(ChineseMedicineClinicsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
