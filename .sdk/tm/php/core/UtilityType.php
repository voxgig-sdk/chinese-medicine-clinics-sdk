...
// ChineseMedicineClinics SDK utility type

class ChineseMedicineClinicsUtility
{
    ...
    public static function copy(ChineseMedicineClinicsUtility $src): ChineseMedicineClinicsUtility
    {
        $u = new ChineseMedicineClinicsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
