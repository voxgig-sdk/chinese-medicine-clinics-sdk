...
// ChineseMedicineClinics SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ChineseMedicineClinicsOmni::makeStructRunner(
    ...
    {
        return ChineseMedicineClinicsOmni::objmodel(ChineseMedicineClinicsOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return ChineseMedicineClinicsOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return ChineseMedicineClinicsOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ChineseMedicineClinicsOmni::structfix($now, Struct::undef()))
                        !== json_encode(ChineseMedicineClinicsOmni::structfix($val, Struct::undef()))) {
