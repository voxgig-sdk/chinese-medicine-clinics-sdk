...
// ChineseMedicineClinics SDK pipeline test
//
...
{
    private static function utility(): ChineseMedicineClinicsUtility
    {
        return new ChineseMedicineClinicsUtility();
    }
    ...
    private static function ctx(array $over = []): ChineseMedicineClinicsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ChineseMedicineClinicsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ChineseMedicineClinicsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ChineseMedicineClinicsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ChineseMedicineClinicsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ChineseMedicineClinicsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ChineseMedicineClinicsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ChineseMedicineClinicsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ChineseMedicineClinicsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ChineseMedicineClinicsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ChineseMedicineClinicsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ChineseMedicineClinicsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ChineseMedicineClinicsResponse([]),
            'result' => new ChineseMedicineClinicsResult([]),
        ]);
        [, $err] = ChineseMedicineClinicsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ChineseMedicineClinicsSpec([]),
            'response' => null,
            'result' => new ChineseMedicineClinicsResult([]),
        ]);
        [, $err] = ChineseMedicineClinicsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ChineseMedicineClinicsSpec(['step' => 's']),
            'response' => new ChineseMedicineClinicsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ChineseMedicineClinicsResult([]),
        ]);
        [, $err] = ChineseMedicineClinicsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ChineseMedicineClinicsSpec(['step' => 's']),
            'response' => new ChineseMedicineClinicsResponse(self::resp(200, ['v' => 1])),
            'result' => new ChineseMedicineClinicsResult([]),
        ]);
        [, $err] = ChineseMedicineClinicsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ChineseMedicineClinicsSpec(['step' => 's']),
            'response' => new ChineseMedicineClinicsResponse(self::resp(200, ['v' => 2])),
            'result' => new ChineseMedicineClinicsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ChineseMedicineClinicsMakeResponse::call($ctx);
    ...
    {
        $preset = new ChineseMedicineClinicsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ChineseMedicineClinicsSpec([]),
            'response' => new ChineseMedicineClinicsResponse([]),
            'result' => new ChineseMedicineClinicsResult([]),
        ...
        [$got, $err] = ChineseMedicineClinicsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ChineseMedicineClinicsResult([])]);
        [, $err] = ChineseMedicineClinicsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ChineseMedicineClinicsSpec([]), 'result' => null]);
        [, $err] = ChineseMedicineClinicsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ChineseMedicineClinicsSpec(['step' => 's']),
            'result' => new ChineseMedicineClinicsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ChineseMedicineClinicsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ChineseMedicineClinicsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ChineseMedicineClinicsSpec(['step' => 's']),
            'result' => new ChineseMedicineClinicsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ChineseMedicineClinicsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ChineseMedicineClinicsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ChineseMedicineClinicsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ChineseMedicineClinicsSpec([]),
            'result' => new ChineseMedicineClinicsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ChineseMedicineClinicsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ChineseMedicineClinicsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ChineseMedicineClinicsError('boom', 'boom');
        $utility->fetcher = function (ChineseMedicineClinicsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ChineseMedicineClinicsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ChineseMedicineClinicsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ChineseMedicineClinicsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ChineseMedicineClinicsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ChineseMedicineClinicsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ChineseMedicineClinicsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ChineseMedicineClinicsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ChineseMedicineClinicsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ChineseMedicineClinicsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ChineseMedicineClinicsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ChineseMedicineClinicsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ChineseMedicineClinicsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ChineseMedicineClinicsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ChineseMedicineClinicsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ChineseMedicineClinicsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ChineseMedicineClinicsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ChineseMedicineClinicsResult(['ok' => false])]);
        $this->expectException(ChineseMedicineClinicsError::class);
        ChineseMedicineClinicsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ChineseMedicineClinicsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ChineseMedicineClinicsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ChineseMedicineClinicsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ChineseMedicineClinicsBaseFeature();
        $b = new ChineseMedicineClinicsBaseFeature();
        ChineseMedicineClinicsFeatureAdd::call($ctx, $a);
        ChineseMedicineClinicsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ChineseMedicineClinicsBaseFeature
    {
        $f = new ChineseMedicineClinicsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ChineseMedicineClinicsFeatureAdd::call($ctx, self::named_feature('a'));
        ChineseMedicineClinicsFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        ChineseMedicineClinicsFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        ChineseMedicineClinicsFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        ChineseMedicineClinicsFeatureAdd::call($ctx, $replace);
        ...
        ChineseMedicineClinicsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ChineseMedicineClinicsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ChineseMedicineClinicsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ChineseMedicineClinicsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        ChineseMedicineClinicsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ChineseMedicineClinicsResponse(['headers' => null]),
            'result' => new ChineseMedicineClinicsResult([]),
        ]);
        ChineseMedicineClinicsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        ChineseMedicineClinicsResultBody::call($ctx);
