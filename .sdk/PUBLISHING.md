...
|---|---|---|
| `ts/` | @voxgig-sdk/chinese-medicine-clinics-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/chinese-medicine-clinics-sdk \
      --repository voxgig-sdk/chinese-medicine-clinics-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/chinese-medicine-clinics-sdk` shows it, and
`npm trust revoke @voxgig-sdk/chinese-medicine-clinics-sdk --id=<id>` removes it.
