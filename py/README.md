...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.AnnualAttendancesEn()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/chinese-medicine-clinics-sdk/releases)) or
...
```
py/
├── chinesemedicineclinics_sdk.py         -- Main SDK module
