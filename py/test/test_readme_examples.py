# ChineseMedicineClinics SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from chinesemedicineclinics_sdk import ChineseMedicineClinicsSDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"ChineseMedicineClinicsSDK": ChineseMedicineClinicsSDK, "os": os}
        try:
