# ChineseMedicineClinics SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ChineseMedicineClinicsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ChineseMedicineClinicsSDK(...) and ChineseMedicineClinicsSDK.test(...) become
#      ChineseMedicineClinicsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "chinesemedicineclinics_sdk"
_SDK_CLASS = "ChineseMedicineClinicsSDK"
...
_ENTITIES = {
    "AnnualAttendancesEn": "annual_attendances_en",
    "AnnualAttendancesSc": "annual_attendances_sc",
    "AnnualAttendancesTc": "annual_attendances_tc",
}
