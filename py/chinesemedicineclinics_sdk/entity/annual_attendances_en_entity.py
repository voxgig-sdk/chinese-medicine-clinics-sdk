...
class AnnualAttendancesEnEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AnnualAttendancesEnEntity(self._client, opts)
    ...
    def data_get(self) -> AnnualAttendancesEn:
    ...
    def match_get(self) -> AnnualAttendancesEn:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[AnnualAttendancesEn]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.AnnualAttendancesEn().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
