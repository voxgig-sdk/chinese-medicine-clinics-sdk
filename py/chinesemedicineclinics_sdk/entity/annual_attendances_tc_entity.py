...
class AnnualAttendancesTcEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AnnualAttendancesTcEntity(self._client, opts)
    ...
    def data_get(self) -> AnnualAttendancesTc:
    ...
    def match_get(self) -> AnnualAttendancesTc:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[AnnualAttendancesTc]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.AnnualAttendancesTc().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
