...
from chinesemedicineclinics_sdk.chinesemedicineclinics_types import (
    AnnualAttendancesSc,
    AnnualAttendancesScListMatch,
)
...
class AnnualAttendancesScEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AnnualAttendancesScEntity(self._client, opts)
    ...
    def data_get(self) -> AnnualAttendancesSc:
    ...
    def match_get(self) -> AnnualAttendancesSc:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[AnnualAttendancesSc]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.AnnualAttendancesSc().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
