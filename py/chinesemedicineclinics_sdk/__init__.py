...
from chinesemedicineclinics_sdk.utility import register

# Load features
from chinesemedicineclinics_sdk.feature.base_feature import ChineseMedicineClinicsBaseFeature
from chinesemedicineclinics_sdk.features import _has_feature, _make_feature
...
class ChineseMedicineClinicsSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ChineseMedicineClinicsUtility()
    ...
    def get_utility(self):
        return ChineseMedicineClinicsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ChineseMedicineClinicsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def AnnualAttendancesEn(self, data=None) -> "AnnualAttendancesEnEntity":
        ...
        from chinesemedicineclinics_sdk.entity.annual_attendances_en_entity import AnnualAttendancesEnEntity
    ...
    def AnnualAttendancesSc(self, data=None) -> "AnnualAttendancesScEntity":
        ...
        from chinesemedicineclinics_sdk.entity.annual_attendances_sc_entity import AnnualAttendancesScEntity
    ...
    def AnnualAttendancesTc(self, data=None) -> "AnnualAttendancesTcEntity":
        ...
        from chinesemedicineclinics_sdk.entity.annual_attendances_tc_entity import AnnualAttendancesTcEntity
