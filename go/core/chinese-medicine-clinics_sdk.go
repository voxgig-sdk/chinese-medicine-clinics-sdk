...
type ChineseMedicineClinicsSDK struct {
	Mode     string
...
func (sdk *ChineseMedicineClinicsSDK) OptionsMap() map[string]any {
...
func (sdk *ChineseMedicineClinicsSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ChineseMedicineClinicsSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ChineseMedicineClinicsSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ChineseMedicineClinicsSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ChineseMedicineClinicsSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ChineseMedicineClinicsSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ChineseMedicineClinicsSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ChineseMedicineClinicsSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ChineseMedicineClinicsSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ChineseMedicineClinicsSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *ChineseMedicineClinicsSDK {
	...
	sdk := NewChineseMedicineClinicsSDK(sdkopts)
	sdk.Mode = "test"
