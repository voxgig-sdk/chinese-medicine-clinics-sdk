...
The Golang SDK for the ChineseMedicineClinics API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/chinese-medicine-clinics-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/chinese-medicine-clinics-sdk=../path/to/github.com/voxgig-sdk/chinese-medicine-clinics-sdk
```
...
```
github.com/voxgig-sdk/chinese-medicine-clinics-sdk/
...
The root package (`github.com/voxgig-sdk/chinese-medicine-clinics-sdk`) re-exports everything needed
