...
const testSeed = `map[string]any{"entity": map[string]any{"annual_attendances_en": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "annual_attendances_sc": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "annual_attendances_tc": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
