# ChineseMedicineClinics Golang SDK Reference

Complete API reference for the ChineseMedicineClinics Golang SDK.
...
#### `Test() *ChineseMedicineClinicsSDK`
...
#### `TestSDK(testopts, sdkopts map[string]any) *ChineseMedicineClinicsSDK`
...
#### `AnnualAttendancesEn(data map[string]any) ChineseMedicineClinicsEntity`

Create a new `AnnualAttendancesEn` entity instance. Pass `nil` for no initial data.

#### `AnnualAttendancesSc(data map[string]any) ChineseMedicineClinicsEntity`

Create a new `AnnualAttendancesSc` entity instance. Pass `nil` for no initial data.

#### `AnnualAttendancesTc(data map[string]any) ChineseMedicineClinicsEntity`

Create a new `AnnualAttendancesTc` entity instance. Pass `nil` for no initial data.
