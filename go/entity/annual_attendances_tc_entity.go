...
func NewAnnualAttendancesTcEntity(client *core.ChineseMedicineClinicsSDK, entopts map[string]any) *AnnualAttendancesTcEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AnnualAttendancesTcEntity) GetName() string { return e.name }
...
func (e *AnnualAttendancesTcEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AnnualAttendancesTcEntity) Deleted() bool {
	return e.deleted
}


func (e *AnnualAttendancesTcEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAnnualAttendancesTcEntity(e.client, opts)
}

func (e *AnnualAttendancesTcEntity) Data(args ...any) any {
...
func (e *AnnualAttendancesTcEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AnnualAttendancesTc; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AnnualAttendancesTcEntity) DataTyped(data ...AnnualAttendancesTc) AnnualAttendancesTc {
	if len(data) > 0 {
		return typedFrom[AnnualAttendancesTc](e.Data(asMap(data[0])))
	}
	return typedFrom[AnnualAttendancesTc](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AnnualAttendancesTc (all fields
// optional at the wire level).
func (e *AnnualAttendancesTcEntity) MatchTyped(match ...AnnualAttendancesTc) AnnualAttendancesTc {
	if len(match) > 0 {
		return typedFrom[AnnualAttendancesTc](e.Match(asMap(match[0])))
	}
	return typedFrom[AnnualAttendancesTc](e.Match())
}
...
func (e *AnnualAttendancesTcEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AnnualAttendancesTcEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AnnualAttendancesTcEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AnnualAttendancesTcListMatch and returns []AnnualAttendancesTc. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AnnualAttendancesTcEntity) ListTyped(reqmatch AnnualAttendancesTcListMatch, ctrl map[string]any) ([]AnnualAttendancesTc, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[AnnualAttendancesTc](res), nil
}



func (e *AnnualAttendancesTcEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AnnualAttendancesTcEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AnnualAttendancesTcEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AnnualAttendancesTcEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
