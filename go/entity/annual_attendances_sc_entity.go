...
type AnnualAttendancesScEntity struct {
	name    string
...
func NewAnnualAttendancesScEntity(client *core.ChineseMedicineClinicsSDK, entopts map[string]any) *AnnualAttendancesScEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AnnualAttendancesScEntity) GetName() string { return e.name }
...
func (e *AnnualAttendancesScEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AnnualAttendancesScEntity) Deleted() bool {
	return e.deleted
}


func (e *AnnualAttendancesScEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAnnualAttendancesScEntity(e.client, opts)
}

func (e *AnnualAttendancesScEntity) Data(args ...any) any {
...
func (e *AnnualAttendancesScEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *AnnualAttendancesScEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AnnualAttendancesScEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *AnnualAttendancesScEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AnnualAttendancesScEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AnnualAttendancesScEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AnnualAttendancesScEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
