...
type AnnualAttendancesEnEntity struct {
	name    string
	client  *core.ChineseMedicineClinicsSDK
...
func NewAnnualAttendancesEnEntity(client *core.ChineseMedicineClinicsSDK, entopts map[string]any) *AnnualAttendancesEnEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AnnualAttendancesEnEntity) GetName() string { return e.name }
...
func (e *AnnualAttendancesEnEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AnnualAttendancesEnEntity) Deleted() bool {
	return e.deleted
}


func (e *AnnualAttendancesEnEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAnnualAttendancesEnEntity(e.client, opts)
}

func (e *AnnualAttendancesEnEntity) Data(args ...any) any {
...
func (e *AnnualAttendancesEnEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AnnualAttendancesEn; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AnnualAttendancesEnEntity) DataTyped(data ...AnnualAttendancesEn) AnnualAttendancesEn {
	if len(data) > 0 {
		return typedFrom[AnnualAttendancesEn](e.Data(asMap(data[0])))
	}
	return typedFrom[AnnualAttendancesEn](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AnnualAttendancesEn (all fields
// optional at the wire level).
func (e *AnnualAttendancesEnEntity) MatchTyped(match ...AnnualAttendancesEn) AnnualAttendancesEn {
	if len(match) > 0 {
		return typedFrom[AnnualAttendancesEn](e.Match(asMap(match[0])))
	}
	return typedFrom[AnnualAttendancesEn](e.Match())
}
...
func (e *AnnualAttendancesEnEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AnnualAttendancesEnEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AnnualAttendancesEnEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AnnualAttendancesEnListMatch and returns []AnnualAttendancesEn. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AnnualAttendancesEnEntity) ListTyped(reqmatch AnnualAttendancesEnListMatch, ctrl map[string]any) ([]AnnualAttendancesEn, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[AnnualAttendancesEn](res), nil
}



func (e *AnnualAttendancesEnEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AnnualAttendancesEnEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AnnualAttendancesEnEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AnnualAttendancesEnEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
