...
This API provides access to the attendance data of Chinese medicine clinics and training and research centers.

Learn more about Chinese Medicine Clinics at [www.ha.org.hk/opendata/cmctr/Data-Specification-for-CMCTR-attnd-en.pdf](https://www.ha.org.hk/opendata/cmctr/Data-Specification-for-CMCTR-attnd-en.pdf).

This is an unofficial SDK for the Chinese Medicine Clinics public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| Go CLI | `github.com/voxgig-sdk/chinese-medicine-clinics-sdk/go-cli` | `go install github.com/voxgig-sdk/chinese-medicine-clinics-sdk/go-cli/cmd/chinese-medicine-clinics@latest` |
| Go MCP server | `github.com/voxgig-sdk/chinese-medicine-clinics-sdk/go-mcp` | `go get github.com/voxgig-sdk/chinese-medicine-clinics-sdk/go-mcp@latest` |
...
$annualattendancesens = $client->AnnualAttendancesEn()->list();
print_r(array_map(fn($item) => $item->data_get(), $annualattendancesens));
```
