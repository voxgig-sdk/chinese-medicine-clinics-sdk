...
type Args struct {
	Entity string         `json:"entity" jsonschema:"annual_attendances_en | annual_attendances_sc | annual_attendances_tc"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ChineseMedicineClinicsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "chinese-medicine-clinics_list",
		Description: "List records from ChineseMedicineClinics. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "chinese-medicine-clinics_load",
		Description: "Load a single record from ChineseMedicineClinics. " +
...
func runOp(client *sdk.ChineseMedicineClinicsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ChineseMedicineClinicsSDK, name string) (sdk.ChineseMedicineClinicsEntity, error) {
	switch strings.ToLower(name) {
	case "annual_attendances_en":
		return client.AnnualAttendancesEn(nil), nil
	case "annual_attendances_sc":
		return client.AnnualAttendancesSc(nil), nil
	case "annual_attendances_tc":
		return client.AnnualAttendancesTc(nil), nil
