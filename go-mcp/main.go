// Command ChineseMedicineClinics-mcp is an MCP server exposing the ChineseMedicineClinics
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ChineseMedicineClinics_list  — list records of an entity
//	ChineseMedicineClinics_load  — load a single record of an entity
//
