...
The Ruby SDK for the ChineseMedicineClinics API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.ChineseMedicineClinics(nil).load(
  { "id" => "test01" }, nil
)
