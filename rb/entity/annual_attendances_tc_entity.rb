...
class AnnualAttendancesTcEntity
  ...
  def make
    opts = @_entopts.dup
    AnnualAttendancesTcEntity.new(@_client, opts)
  end
  ...
  # @return [AnnualAttendancesTc, Hash] the current AnnualAttendancesTc data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AnnualAttendancesTc fields)
  def match_get
  ...
  #
  # @param reqmatch [AnnualAttendancesTcListMatch, Hash, nil] match filter (any subset of
  #   AnnualAttendancesTc fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<AnnualAttendancesTc>, Array] the matching AnnualAttendancesTc items; raises ChineseMedicineClinicsError on failure
