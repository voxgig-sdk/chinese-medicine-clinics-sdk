...
class AnnualAttendancesScEntity
  ...
  def make
    opts = @_entopts.dup
    AnnualAttendancesScEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [AnnualAttendancesScListMatch, Hash, nil] match filter (any subset of
  #   AnnualAttendancesSc fields); defaults to nil, treated as an empty match that lists all.
