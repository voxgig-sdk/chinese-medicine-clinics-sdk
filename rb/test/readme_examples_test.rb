...
#      offline in seeded test mode (ChineseMedicineClinicsSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ChineseMedicineClinics_sdk.rb")
  SDK_CLASS = "ChineseMedicineClinicsSDK"
  ...
  SDK_BASE = "ChineseMedicineClinics_sdk"
