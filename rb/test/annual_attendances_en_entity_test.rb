...
class AnnualAttendancesEnEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set CHINESE_MEDICINE_CLINICS_TEST_ANNUAL_ATTENDANCES_EN_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def annual_attendances_en_basic_setup(extra)
  ...
  entid_env_raw = ENV["CHINESE_MEDICINE_CLINICS_TEST_ANNUAL_ATTENDANCES_EN_ENTID"]
