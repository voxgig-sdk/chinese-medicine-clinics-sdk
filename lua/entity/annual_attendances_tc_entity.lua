...
local AnnualAttendancesTcEntity = {}
AnnualAttendancesTcEntity.__index = AnnualAttendancesTcEntity


function AnnualAttendancesTcEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AnnualAttendancesTcEntity)
  self._name = "annual_attendances_tc"
  self._client = client
...
function AnnualAttendancesTcEntity:get_name()
  return self._name
end


function AnnualAttendancesTcEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AnnualAttendancesTcEntity.new(self._client, opts)
end
...
function AnnualAttendancesTcEntity:mark_deleted()
  self._deleted = true
end


function AnnualAttendancesTcEntity:deleted()
  return true == self._deleted
end


function AnnualAttendancesTcEntity:data_set(args)
  if args ~= nil then
...
function AnnualAttendancesTcEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AnnualAttendancesTcEntity:match_set(args)
  if args ~= nil then
...
function AnnualAttendancesTcEntity:match_get()
...
function AnnualAttendancesTcEntity:stream(action, args, callopts)
...
---@param reqmatch AnnualAttendancesTcListMatch
---@param ctrl? table
---@return AnnualAttendancesTc[]
---@return string? err
function AnnualAttendancesTcEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function AnnualAttendancesTcEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AnnualAttendancesTcEntity
