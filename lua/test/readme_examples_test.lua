...
local SDK_MODULE = "chinese-medicine-clinics_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["annual_attendances_en"] = { ["test01"] = { id = "test01" } }, ["annual_attendances_sc"] = { ["test01"] = { id = "test01" } }, ["annual_attendances_tc"] = { ["test01"] = { id = "test01" } } } }'
