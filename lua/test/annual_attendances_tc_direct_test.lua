...
describe("AnnualAttendancesTcDirect", function()
  it("should direct-list-annual_attendances_tc", function()
    local setup = annual_attendances_tc_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-annual_attendances_tc", setup.live and "live" or "unit")
...
function annual_attendances_tc_direct_setup(mockres)
