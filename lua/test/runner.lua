...
function runner.env_override(m)
  local live = runner.getenv("CHINESE_MEDICINE_CLINICS_TEST_LIVE")
  local override = runner.getenv("CHINESE_MEDICINE_CLINICS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CHINESE_MEDICINE_CLINICS_TEST_EXPLAIN")
