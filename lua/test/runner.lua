...
function runner.env_override(m)
  local live = runner.getenv("CHINESEMEDICINECLINICS_TEST_LIVE")
  local override = runner.getenv("CHINESEMEDICINECLINICS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CHINESEMEDICINECLINICS_TEST_EXPLAIN")
