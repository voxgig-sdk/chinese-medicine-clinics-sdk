...
// ChineseMedicineClinics SDK AnnualAttendancesTc entity
...
class AnnualAttendancesTcEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "annual_attendances_tc";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AnnualAttendancesTcEntity($this->_client, $opts);
    }

    /**
     * @param AnnualAttendancesTc|array $args AnnualAttendancesTc data (assoc-array) to store.
     */
    ...
    /**
     * @return AnnualAttendancesTc|array The current AnnualAttendancesTc data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AnnualAttendancesTc fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AnnualAttendancesTc fields).
     */
    ...
    /**
     * List AnnualAttendancesTc items matching the given filter.
     *
     * @param AnnualAttendancesTcListMatch|array|null $reqmatch Match filter (any subset
     *   of AnnualAttendancesTc fields) as an assoc-array; AnnualAttendancesTcListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AnnualAttendancesTc[]|array A list of AnnualAttendancesTc items as assoc-arrays at
