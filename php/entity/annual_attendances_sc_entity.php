...
class AnnualAttendancesScEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "annual_attendances_sc";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AnnualAttendancesScEntity($this->_client, $opts);
    }

    /**
     * @param AnnualAttendancesSc|array $args AnnualAttendancesSc data (assoc-array) to store.
     */
    ...
    /**
     * @return AnnualAttendancesSc|array The current AnnualAttendancesSc data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AnnualAttendancesSc fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AnnualAttendancesSc fields).
     */
     ...
     *
     * @param AnnualAttendancesScListMatch|array|null $reqmatch Match filter (any subset
     *   of AnnualAttendancesSc fields) as an assoc-array; AnnualAttendancesScListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AnnualAttendancesSc[]|array A list of AnnualAttendancesSc items as assoc-arrays at
