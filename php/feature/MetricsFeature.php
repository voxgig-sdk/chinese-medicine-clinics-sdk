...
// ChineseMedicineClinics SDK metrics feature
...
class ChineseMedicineClinicsMetricsFeature extends ChineseMedicineClinicsBaseFeature
{
    ...
    private function _record(ChineseMedicineClinicsContext $ctx, bool $ok): void
    {
