...
// ChineseMedicineClinics SDK timeout feature
...
class ChineseMedicineClinicsTimeoutFeature extends ChineseMedicineClinicsBaseFeature
{
    ...
    private function _with_timeout(ChineseMedicineClinicsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ChineseMedicineClinicsContext $_ctx, float $ms): void
    {
        $client = $this->client;
