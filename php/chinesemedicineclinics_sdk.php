...
class ChineseMedicineClinicsSDK
{
    public string $mode;
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = ChineseMedicineClinicsHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = ChineseMedicineClinicsHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!ChineseMedicineClinicsFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, ChineseMedicineClinicsFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return ChineseMedicineClinicsUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = ChineseMedicineClinicsHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = ChineseMedicineClinicsHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = ChineseMedicineClinicsHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new ChineseMedicineClinicsError($op . "_allow",
                "ChineseMedicineClinicsSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = ChineseMedicineClinicsHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new ChineseMedicineClinicsError("graphql_error",
                "ChineseMedicineClinicsSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function AnnualAttendancesEn($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_annual_attendances_en === null) {
                $this->_annual_attendances_en = new AnnualAttendancesEnEntity($this, null);
            }
            return $this->_annual_attendances_en;
        }
        return new AnnualAttendancesEnEntity($this, $data);
    }
    ...
    public function AnnualAttendancesSc($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_annual_attendances_sc === null) {
                $this->_annual_attendances_sc = new AnnualAttendancesScEntity($this, null);
            }
            return $this->_annual_attendances_sc;
        }
        return new AnnualAttendancesScEntity($this, $data);
    }
    ...
    public function AnnualAttendancesTc($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_annual_attendances_tc === null) {
                $this->_annual_attendances_tc = new AnnualAttendancesTcEntity($this, null);
            }
            return $this->_annual_attendances_tc;
        }
        return new AnnualAttendancesTcEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new ChineseMedicineClinicsSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
