...
// ChineseMedicineClinics SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ChineseMedicineClinicsSDK::test)
...
{
    private const SDK_CLASS = 'ChineseMedicineClinicsSDK';
    ...
    private const SDK_BASE = 'chinesemedicineclinics_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../chinesemedicineclinics_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
