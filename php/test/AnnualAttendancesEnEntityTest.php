...
class AnnualAttendancesEnEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->AnnualAttendancesEn(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->AnnualAttendancesEn(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CHINESE_MEDICINE_CLINICS_TEST_ANNUAL_ATTENDANCES_EN_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $annual_attendances_en_ref01_list_result = $annual_attendances_en_ref01_ent->list($annual_attendances_en_ref01_match, null);
...
function annual_attendances_en_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CHINESE_MEDICINE_CLINICS_TEST_ANNUAL_ATTENDANCES_EN_ENTID");
