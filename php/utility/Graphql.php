...
// ChineseMedicineClinics SDK utility: graphql
//
...
class ChineseMedicineClinicsGraphql
{
    ...
    // equivalent.
    public static function body(ChineseMedicineClinicsContext $ctx): mixed
    {
    ...
    public static function errors(ChineseMedicineClinicsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
