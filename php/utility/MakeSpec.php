...
// ChineseMedicineClinics SDK utility: make_spec

require_once __DIR__ . '/Graphql.php';

require_once __DIR__ . '/../core/Spec.php';

class ChineseMedicineClinicsMakeSpec
{
    public static function call(ChineseMedicineClinicsContext $ctx): array
    {
        ...
        if ('graphql' === \Voxgig\Struct\Struct::getprop($point, 'kind')) {
            ...
            $ctx->spec->query = [];
            $ctx->spec->headers['content-type'] = ChineseMedicineClinicsGraphql::CONTENT_TYPE;
        } else {
