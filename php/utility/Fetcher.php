...
// ChineseMedicineClinics SDK utility: fetcher

class ChineseMedicineClinicsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ChineseMedicineClinicsSDK/1.0)';
    ...
    public static function call(ChineseMedicineClinicsContext $ctx, string $fullurl, array $fetchdef): array
    {
